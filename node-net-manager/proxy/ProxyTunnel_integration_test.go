...
func (f *integFakeEnv) GetTableEntryByServiceIP(ip net.IP) []TableEntryCache.TableEntry {
	return f.entriesBySIP[ip.String()]
}
func (f *integFakeEnv) GetTableEntryByNsIP(ip net.IP) (TableEntryCache.TableEntry, bool) {
	return TableEntryCache.TableEntry{}, false
}
func (f *integFakeEnv) GetTableEntryByInstanceIP(ip net.IP) (TableEntryCache.TableEntry, bool) {
	return TableEntryCache.TableEntry{}, false
}
